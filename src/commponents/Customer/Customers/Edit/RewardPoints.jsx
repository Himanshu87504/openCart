...
export default function RewardPoints() {
    return (
        <div className="w-full bg-white p-6 border rounded shadow">
                ...
                <table className="min-w-full border-collapse">
                    <thead>
                        <tr className="bg-gray-100 border">
                            ...
                            <th className="p-3 border text-left font-semibold">Points</th>
                        </tr>
                    </thead>
            ...
            <h2 className="text-2xl font-semibold mb-4">Add Reward Points</h2>
            ...
            <div className="w-full border-t pt-4">
                ...
                <div className="flex items-start mb-6">
                    <label className="w-48 font-medium mt-2">Points</label>
