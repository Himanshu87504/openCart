    ...
    return (
        <div className="p-4 bg-white border rounded">
            ...
            <h2 className="text-lg font-semibold flex items-center gap-2 mb-4">
                <span className="text-gray-700">✏️</span> Edit Banner
            </h2>
            ...
            <div className="mb-4">
                ...
                <div
                    className="relative inline-block w-14 ml-4 align-middle select-none"
            ...
            {/* LANGUAGE TAB */}
            <div className="border rounded mb-4 inline-block">
            ...
            {/* TABLE HEADER */}
            <div className="grid grid-cols-12 bg-gray-100 border-b py-2 text-sm font-semibold">
            ...
            {/* DYNAMIC ROWS */}
            {rows.map((row) => (
                <div key={row.id} className="grid grid-cols-12 border-b py-4">
                    ...
                    {/* IMAGE */}
                    <div className="col-span-3 px-2">
                        <div className="border rounded bg-white h-40 flex items-center justify-center">
                            {row.image ? (
