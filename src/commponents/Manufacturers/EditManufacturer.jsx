    ...
    return (
        <div className="min-h-screen bg-[#f5f5f5] py-6">
            ...
            <div className="mx-auto w-[98%] max-w-7xl bg-white border border-[#e5e5e5]">
                ...
                {/* Tabs */}
                <div className="px-6 pt-2 border-b border-[#e5e5e5]">
                ...
                <div className="px-6 py-3 space-y-3 pl-2">
                    ...
                    {activeTab === "General" && (
                        <>
                            ...
                            {/* Stores */}
                            <div className="flex gap-5 items-start pl-4 md:p-3">
                                <label className="text-sm font-semibold text-[#555] pl-2 md:pl-34">
                                    Stores
                                </label>
                                <div className="border border-[#d7d7d7] rounded-md px-4 py-3 text-sm w-full ">
                                    <label className="flex  gap-2 h-30">
                                        <input
                                            type="checkbox"
                                            defaultChecked
                                            className="h-4 w-4"
                            ...
                            {/* Image */}
                            <div className=" flex items-start pl-2 md:pl-34">
                                <label className="text-sm font-semibold text-[#555] w-20">Image</label>
                                <div>
                                    <div className="border border-[#e5e5e5] bg-white w-52 h-60 flex items-center justify-center mb-2">
                                        <img
                            ...
                            {/* Sort Order */}
                            <div className="flex  items-center pl-2 md:pl-34">
                                <label className="text-sm font-semibold text-[#555] w-25">
                                    Sort-Order
                                </label>
                                <input
                                    type="number"
                    ...
                    {/* -------------------- SEO TAB -------------------- */}
                    {activeTab === "SEO" && (
                        <div className="w-full px-2 py-2 text-sm text-gray-700">
