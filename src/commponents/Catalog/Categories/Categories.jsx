        ...
        <div className="w-full bg-[#F6F6F6]  p-1">
            ...
            <div className="min-h-screen bg-gray-100 p-2">
                <div className="mx-auto max-w-8xl bg-white shadow">
                    <div className="bg-[#F8F8F8] w-full p-1 pl-3 border-gray-300 border flex items-center gap-1.5">
                        <BiCategory />
                    ...
                    <table className="min-w-full text-sm text-[#1A7BB0]">
                        ...
                        <tbody className="border-gray-300 border">
                            {currentItems.map((cat) => (
                                <tr key={cat.id} className="hover:bg-gray-50 border-gray-300 border">
                                    ...
                                    <td className="px-3 py-2 border-gray-300 border">
                                        <div>{cat.name}</div>
                                        <div className="text-xs text-green-600">{cat.status}</div>
                                    </td>
                                    <td className="px-3 py-2 border-gray-300 border">{cat.sortOrder}</td>
                                    <td className="px-3 py-2 border-gray-300 border">
                                        <Link
